...
class Settings_Sections_Fields {
	...
	function register_sections_fields() {
		...
		if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			add_settings_field(
				$field_id,
				__( 'Login Button Color', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_color_picker_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
		...
		add_settings_field(
			$field_id,
			__( 'Registration Date Column', 'admin-site-enhancements' ), // Field title
			[ $render_field, 'render_checkbox_toggle' ],
			ASENHA_SLUG,
			'main-section',
			array(
        ...
        if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			add_settings_field(
				$field_id,
				__( 'Enable access for non-authenticated users to REST API routes that contains the following strings:', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_textarea_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
		...
		if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			add_settings_field(
				$field_id,
				__( 'CAPTCHA Protection', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_checkbox_toggle' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'On WordPress forms:', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_checkboxes_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			if ( in_array( 'woocommerce/woocommerce.php', get_option( 'active_plugins', array() ) ) ) {
				...
				add_settings_field(
					$field_id,
					__( 'On WooCommerce forms:', 'admin-site-enhancements' ), // Field title
					[ $render_field, 'render_checkboxes_subfield' ],
					ASENHA_SLUG,
					'main-section',
					array(
			...
			add_settings_field(
				$field_id,
				__( 'CAPTCHA type', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Secret key', 'admin-site-enhancements' ) . ' <span class="faded">(' . __ ( 'auto-generated', 'admin-site-enhancements' ) . ')</span>', // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'ALTCHA widget', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Complexity', 'admin-site-enhancements' ) . ' <span class="faded">(' . __ ( 'of the CAPTCHA challenge', 'admin-site-enhancements' ) . ')</span>', // Field title
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Expiration', 'admin-site-enhancements' ) . ' <span class="faded">(' . __ ( 'the life-span of the challenge', 'admin-site-enhancements' ) . ')</span>', // Field title
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Auto verification', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Label for checkbox', 'admin-site-enhancements' ) . ' <span class="faded">(' . __( 'Default:', 'admin-site-enhancements' ) . ' ' . __( "I'm not a robot", "admin-site-enhancements" ) . ')</span>', // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Label for verification process', 'admin-site-enhancements' ) . ' <span class="faded">(' . __( 'Default:', 'admin-site-enhancements' ) . ' ' . __( "Verifying you're not a robot...", "admin-site-enhancements" ) . ')</span>', // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Label for verification wait request', 'admin-site-enhancements' ) . ' <span class="faded">(' . __( 'Default:', 'admin-site-enhancements' ) . ' ' . __( "Verifying... please wait.", "admin-site-enhancements" ) . ')</span>', // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Label for verification success', 'admin-site-enhancements' ) . ' <span class="faded">(' . __( 'Default:', 'admin-site-enhancements' ) . ' ' . __( "Verified", "admin-site-enhancements" ) . ')</span>', // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Label for verification failure', 'admin-site-enhancements' ) . ' <span class="faded">(' . __( 'Default:', 'admin-site-enhancements' ) . ' ' . __( "Verification failed. Try again later.", "admin-site-enhancements" ) . ')</span>', // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'reCAPTCHA widget', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Site key', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Secret key', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Widget theme', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
		...
		if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			add_settings_field(
				$field_id,
				__( '<span class="field-sublabel sublabel-wide">Authentication</span>', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_radio_buttons_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
		...
		if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			add_settings_field(
				$field_id,
				__( 'Form Builder', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_checkbox_toggle' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Email template', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				'Email header image', // Field title
				[ $render_field, 'render_media_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
					...
					'field_intro'					=> '',
					'field_description'				=> '',
					'class'							=> 'asenha-textarea margin-bottom-16 login-logout ' . $field_slug,
				)
			);
			...
			add_settings_field(
				$field_id,
				__( 'Spam protection fields', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_description_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'ALTCHA secret key', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'reCAPTCHA v2 site key', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'reCAPTCHA v2 secret key', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'reCAPTCHA v3 site key', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'reCAPTCHA v3 secret key', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Turnstile site key', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Turnstile secret key', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
        ...
        if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			add_settings_field(
				$field_id,
				__( 'Label for password field', 'admin-site-enhancements' ) . ' <span class="faded">(' . __( 'Default:', 'admin-site-enhancements' ) . ' ' . __( "Password", "admin-site-enhancements" ) . ')</span>', // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			add_settings_field(
				$field_id,
				__( 'Label for button', 'admin-site-enhancements' ) . ' <span class="faded">(' . __( 'Default:', 'admin-site-enhancements' ) . ' ' . __( "View Content", "admin-site-enhancements" ) . ')</span>', // Field title
				[ $render_field, 'render_text_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
        ...
        if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			add_settings_field(
				$field_id,
				__( 'Custom &lt;head&gt; Code', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_textarea_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
        ...
        if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			add_settings_field(
				$field_id,
				__( 'Exclude the following URLs from maintenance mode:', 'admin-site-enhancements' ), // Field title
				[ $render_field, 'render_textarea_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
