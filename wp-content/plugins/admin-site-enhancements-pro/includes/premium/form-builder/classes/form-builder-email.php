...
class Form_Builder_Email {
    ...
    public function send_email() {
        ...
        if ( $mail ) {
            ...
            $enable_db_entries = isset( $form_settings['enable_db_entries'] ) ? $form_settings['enable_db_entries'] : 'on';
    ...
    public static function plain_row_template( $title, $entry_value, $count ) {
        ...
        <div style="width: 100%; margin-bottom: 25px">
            <div style="font-family: sans-serif;font-weight: 600;vertical-align: top;text-align:left; line-height: 18px;"><?php echo esc_html( $title ); ?></div>
            <div style="font-family: sans-serif;vertical-align: top; padding: 4px 0 0 0; line-height: 18px;"><?php echo esc_html( $entry_value ); ?></div>
        </div>
        <?php
        $form_html = ob_get_clean();
        return $form_html;
