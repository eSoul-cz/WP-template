                        ...
                        foreach ( $columns as $column_option_key => $column_option ) {
                            ...
                            ?>
                             <div class="fb-choice fb-checkbox">
                                <input type="radio" id="<?php echo esc_attr( $this->html_id( '-' . $row_option_key . '-' . $column_option_key ) ); ?>" name="<?php echo esc_attr( $this->html_name() ) . '[likert_rows][' . $row_option_key . '][]'; ?>" value="<?php echo esc_attr( $label ); ?>" <?php checked( ( $label == $default ), true ); ?> />
                                <label for="<?php echo esc_attr( $this->html_id( '-' . $row_option_key ) ); ?>"><?php echo esc_html( $label ); ?></label>
                            </div>
                        <?php
                        }
                        ?>
