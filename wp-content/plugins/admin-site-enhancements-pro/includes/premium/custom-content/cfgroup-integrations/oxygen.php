...
class Ase_Oxygen_Integration {
    ...
    function add_button( $result, $field_settings ) {
        ...
        $applicable_field_types = array( 'text', 'textarea', 'wysiwyg', 'color', 'true_false', 'radio', 'select', 'checkbox', 'hyperlink', 'number', 'date', 'time', 'term', 'user', 'relationship', 'file', 'gallery' );
        $properties = [];
