...
class cfgroup_color extends cfgroup_field
{
    ...
    function input_head( $field = null ) {
        ...
        wp_register_script( 'jqcolors', CFG_URL . '/includes/fields/color/colors.js' );
        wp_enqueue_script( 'jqcolors' );
        // wp_register_script( 'jqcolorpicker', CFG_URL . '/includes/fields/color/jqColorPicker.js' );
        // wp_register_script( 'jqcolorpicker', CFG_URL . '/includes/fields/color/jqColorPicker.min.js' );
        wp_register_script( 'jqcolorpicker', CFG_URL . '/includes/fields/color/jqColorPicker_mod.js' );
