...
class Depageviews extends \Breakdance\Elements\Element
{
    ...
    {
        return ['content' => ['main_options' => ['text_before' => ' ', 'text_after' => ' Views', 'tag' => 'p']], 'design' => ['container' => ['baackground_color' => null], 'typography' => ['text' => null, 'count' => null]]];
    }
    ...
    {
        return ['content.main_options.text_before', 'content.main_options.text_after', 'content.main_options.tag'];
    }
}
